...
#define VOLATILE_DEFINITIONS(F) \
    ...
    F(VOLATILE_SPEED_SWAP,                  speedSwap,                     (u32, 1)) \
    F(VOLATILE_GUARD_SPLIT,                 guardSplit,                    (u32, 1)) \
    F(VOLATILE_POWER_SPLIT,                 powerSplit,                    (u32, 1)) \
    F(VOLATILE_ORIGINAL_SPEED,              originalSpeed,                 (u32, UINT32_MAX))
...
#define STATUS_FIELD_SOOTHING_STEAM                 (1 << 14)
#define STATUS_FIELD_GRUDGE                         (1 << 15)
#define STATUS_FIELD_DARKNESS                       (1 << 16)
#define STATUS_FIELD_BOOSTED_CRITS                  (1 << 17)
#define STATUS_FIELD_PETALBURG_GYM                  (1 << 18)
#define STATUS_FIELD_CAMOMONS                       (1 << 19)
#define STATUS_FIELD_WONDER_ROOM_PERMANENT          (1 << 20)
#define STATUS_FIELD_TRICK_ROOM_PERMANENT           (1 << 21)
#define STATUS_FIELD_INNATE_MOVES                   (1 << 22)
#define STATUS_FIELD_MAGNET_RISE                    (1 << 23)

...
enum StringID
{
    ...
    STRINGID_PERMEATINGDARKNESS,
    STRINGID_DARKNESSLIFTED,
    STRINGID_SINISTERAURA,
    STRINGID_CRITROOMBUFF,
    STRINGID_ACCURACYROOMBUFF,
    STRINGID_SPEEDROOMBUFF,
    STRINGID_STRENGTHROOMBUFF,
    STRINGID_RECOVERYROOMBUFF,
    STRINGID_RECOILROOMBUFF,
    STRINGID_ZEROREDUCTIONROOMBUFF,
    STRINGID_LEADERSROOMBUFF,
    STRINGID_VICTORYOVERCRITROOM,
    STRINGID_VICTORYOVERACCURACYROOM,
    STRINGID_VICTORYOVERSPEEDROOM,
    STRINGID_VICTORYOVERSTRENGTHROOM,
    STRINGID_VICTORYOVERRECOVERYROOM,
    STRINGID_VICTORYOVERRECOILROOM,
    STRINGID_VICTORYOVERZEROREDUCTIONROOM,
    STRINGID_COUNT
};
...
// gPetalburgGymPlayerStatusStringIds
enum PetalburgGymPlayerStatusStringID
{

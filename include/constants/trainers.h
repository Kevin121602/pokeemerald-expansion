...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_RILEY,
    TRAINER_PIC_FRONT_CHERYL,
    TRAINER_PIC_FRONT_MARLEY,
    TRAINER_PIC_FRONT_MIRA,
    TRAINER_PIC_FRONT_BUCK,
    TRAINER_PIC_FRONT_CLAIR,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_STAT_TRAINER,
    TRAINER_CLASS_JOHTO_TRAINER,
    TRAINER_CLASS_KANTO_TRAINER,

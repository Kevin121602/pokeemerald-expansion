...
static u8 TranslateWeatherNum(u8 weather)
{
    ...
    case FIELD_EFFECT_GRUDGE_FOG:         return FIELD_EFFECT_GRUDGE_FOG;
    case FIELD_EFFECT_DARKNESS:           return FIELD_EFFECT_DARKNESS;
    case FIELD_EFFECT_BOOSTED_CRITS:      return FIELD_EFFECT_BOOSTED_CRITS;
    case FIELD_EFFECT_PETALBURG_GYM:      return FIELD_EFFECT_PETALBURG_GYM;

...
u32 GetCurrentLevelCap(void)
{
    static const u32 sLevelCapFlagMap[][2] =
    {
        ...
        {FLAG_DEFEATED_BROCK_DESERT, 59}, //58
        {FLAG_DEFEATED_BRUNO_MIRAGE_TOWER, 60}, //59
        {FLAG_DEFEATED_LANCE_MT_CHIMNEY, 61}, //60
        {FLAG_BADGE08_GET, 63}, //62
        {FLAG_DEFEATED_119_RIVAL, 66}, //65
        {FLAG_DEFEATED_SHELLY, 67}, //66
        {FLAG_DEFEATED_KOGA_JANINE, 69}, //68
        {FLAG_BADGE06_GET, 70}, //69
        {FLAG_DEFEATED_LILYCOVE_RIVAL, 71}, //70
        {FLAG_DEFEATED_MAXIE, 73}, //72

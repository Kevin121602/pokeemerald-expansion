...
<<<<<<< HEAD
    TRAINER_SPRITE(TRAINER_PIC_FRONT_RILEY, gTrainerFrontPic_TrainerRiley, gTrainerPalette_TrainerRiley),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_CHERYL, gTrainerFrontPic_TrainerCheryl, gTrainerPalette_TrainerCheryl),
